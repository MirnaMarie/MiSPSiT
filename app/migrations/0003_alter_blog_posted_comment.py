# Generated by Django 4.2.11 on 2024-05-06 20:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='blog',
            name='posted',
            field=models.DateTimeField(db_index=True, default=datetime.datetime(2024, 5, 6, 23, 3, 3, 162500), verbose_name='Опубликована'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(db_index=True, default=datetime.datetime(2024, 5, 6, 23, 3, 3, 162500), verbose_name='Дата комментария')),
